...
class PyNexeCLI:
    ...
    def print_banner(self):
        ...
        banner_text = Text()
        banner_text.append("PyNexe", style="bold blue")
    ...
    def print_help(self):
        ...
        help_text.append("  run                    # Build project\n", style="white")
        help_text.append("  info                   # Show project info\n", style="white")
        ...
        help_text.append("  python pynexe.py help             # Show this help\n\n", style="dim")
        help_text.append("Advanced Usage:\n", style="bold")
        help_text.append(
    ...
    def build_project(self, config_path: str):
        ...
        try:
            ...
            with Progress(
                ...
                # Compilation
                task3 = progress.add_task("Building with Nuitka...", total=1)
                builder.build_with_nuitka()
                progress.update(task3, completed=1, description="✓ Build completed")
    ...
    def run(self):
        ...
        parser = argparse.ArgumentParser(description="PyNexe - Python to Native Executable Builder", add_help=False)
        parser.add_argument(
            "command",
            nargs="?",
