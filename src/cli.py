...
class PyNexeCLI:
    ...
    def print_help(self):
        ...
        help_text.append("  python pynexe.py          # Build project\n", style="white")
        help_text.append("  python pynexe.py --info    # Show project info\n", style="white")
        help_text.append("  python pynexe.py --config my.yaml\n", style="white")
        help_text.append("  python pynexe.py --show-help  # Show this help\n\n", style="white")
        help_text.append("Examples:\n", style="bold")
        help_text.append("  python pynexe.py\n", style="dim")
        help_text.append("  python pynexe.py --info\n", style="dim")
        help_text.append("  python pynexe.py --config my_config.yaml", style="dim")
    ...
    def run(self):
        ...
        parser = argparse.ArgumentParser(description="PyNexe")
